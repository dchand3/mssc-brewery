...
public class CustomerControllerTest {
    ...
    public void handleGet() throws Exception {
        ...
        mockMvc.perform(get(API_V_1_CUSTOMER + validCustomer.getId().toString()).accept(MediaType.APPLICATION_JSON))
    ...
    public void handleUpdate() throws Exception {
        ...
        //when
        mockMvc.perform(put(API_V_1_CUSTOMER + UUID.randomUUID())
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void handleUpdate_validationError_nonNullId() throws Exception {
        //given
        CustomerDto customerDto = validCustomer;
        String customerDtoJson = objectMapper.writeValueAsString(customerDto);
